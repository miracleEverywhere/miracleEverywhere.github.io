...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;">if [ -z &quot;$1&quot; ]; then</span></span>
<span class="line"><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;">    acceleration_index=0</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;">else</span></span>
<span class="line"><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;">    acceleration_index=$1</span></span>
<span class="line"><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;">fi</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;">    echo_green &quot;[8]: 退出脚本&quot;</span></span>
<span class="line"><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;">    echo_yellow &quot;————————————————————————————————————————————————————————————&quot;</span></span>
<span class="line"><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;">    echo_yellow &quot;请输入要执行的操作 [0-8]: &quot;</span></span>
<span class="line"><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;">}</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;">    github_url_acc=$(curl -s -L \${DMP_GITHUB_API_URL} | jq -r &#39;.assets[] | select(.name == &quot;dmp.tgz&quot;) | .browser_download_url&#39;)</span></span>
<span class="line"><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;">    # 生成加速链接</span></span>
<span class="line"><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;">    url=&quot;$(curl -s -L https://api.akams.cn/github | jq -r --arg idx &quot;$acceleration_index&quot; &#39;.data[$idx | tonumber].url&#39;)/\${github_url_acc}&quot;</span></span>
<span class="line"><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;">    echo_yellow &quot;正在使用加速站点[\${acceleration_index}]进行下载，如果下载失败，请切换加速站点，切换方式：&quot;</span></span>
<span class="line"><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;">    echo_yellow &quot;./run.sh 大于等于0的数字。例如：./run.sh 2&quot;</span></span>
<span class="line"><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;">    echo_yellow &quot;如果不输入数字，则默认为0&quot;</span></span>
...
<span class="line"><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;">    # 生成加速链接</span></span>
<span class="line"><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;">    url=&quot;$(curl -s -L https://api.akams.cn/github | jq -r --arg idx &quot;$acceleration_index&quot; &#39;.data[$idx | tonumber].url&#39;)/\${SCRIPT_GITHUB}&quot;</span></span>
<span class="line"><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;">    echo_yellow &quot;正在使用加速站点[\${acceleration_index}]进行下载，如果下载失败，请切换加速站点，切换方式：&quot;</span></span>
<span class="line"><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;">    echo_yellow &quot;./run.sh 大于等于0的数字。例如：./run.sh 2&quot;</span></span>
<span class="line"><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;">    echo_yellow &quot;如果不输入数字，则默认为0&quot;</span></span>
...
<span class="line"><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;">        ;;</span></span>
<span class="line"><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;">    *)</span></span>
<span class="line"><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;">        echo_red &quot;请输入正确的数字 [0-8]&quot;</span></span>
